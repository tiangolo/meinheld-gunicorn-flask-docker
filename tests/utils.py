...
CONTAINER_NAME = "meinheld-gunicorn-flask-test"
...
def get_response_text1() -> str:
    ...
    return f"Hello World from Flask in a Docker container running Python {python_version} with Meinheld and Gunicorn (default)"
