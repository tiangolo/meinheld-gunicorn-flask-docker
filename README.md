...
* ⬆ Bump tiangolo/issue-manager from 0.5.1 to 0.6.0. PR [#174](https://github.com/tiangolo/meinheld-gunicorn-flask-docker/pull/174) by [@dependabot[bot]](https://github.com/apps/dependabot).
